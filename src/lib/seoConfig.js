...
export const FAQ_GENERAL = [
  ...
  { q: "What warranty comes with the installation?", a: "Xtreme Polishing Systems installations include a lifetime satisfaction warranty guaranteed against hot-tire pickup, peeling, and blistering — for as long as you own your home. The warranty is transferable to the next homeowner." },
  { q: "One-day vs. two-day garage floor installation — what's the difference?", a: "One-day polyaspartic systems cure fast but can skip critical moisture-mitigation steps. A two-day system dedicates day one to thorough concrete preparation — grinding, crack repair, and moisture testing — then applies the industrial-grade epoxy, flake, and polyurea topcoat on day two. The two-day process produces a floor that won't peel or suffer hot-tire pickup." },
  { q: "How is a professional epoxy system different from a DIY kit?", a: "Big-box DIY epoxy kits are thin water-based coatings that peel under hot tires within 1–2 years. Professional systems use 100% solids industrial-grade epoxy, decorative flake broadcasts, and UV-stable polyurea topcoats — up to 20x more durable than store-bought kits and backed by a lifetime warranty." },
  { q: "Do you require a deposit before installation?", a: "No. We never ask for an up-front deposit. Your estimate is free, and you don't pay anything until your installation is scheduled and you've approved your final proposal." },
