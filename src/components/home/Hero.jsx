    ...
    <section className="relative h-[72vh] min-h-[520px] bg-stone-950 overflow-hidden border-b-2 border-amber-500">
      ...
      <div className="absolute inset-0 flex items-center">
        <div className="w-full max-w-6xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-2xl bg-white/85 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-xl">
            <span className="inline-block text-amber-500 text-xs font-semibold tracking-[0.2em] uppercase">{settings.service_area}</span>
            <h1 className="mt-4 text-4xl md:text-6xl font-semibold tracking-tight text-stone-950 leading-[1.05]">
