      ...
      <div className="absolute inset-0 flex items-start md:items-center pt-28 md:pt-24">
        <div className="w-full max-w-6xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-2xl">
            ...
            <a href={`tel:${settings.phone}`} className="mt-6 md:mt-8 inline-flex w-full sm:w-auto items-center justify-center gap-3 h-14 md:h-16 px-8 md:px-10 rounded-xl bg-amber-500 hover:bg-amber-400 transition text-stone-950 text-base font-bold tracking-wide shadow-lg shadow-amber-500/30 border border-white/80">
              <Phone className="h-5 w-5" /> Call Now: {settings.phone}
            </a>
