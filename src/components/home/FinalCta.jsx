  ...
  return (
    <section className="bg-amber-500 py-16 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <Link to="/funnel" className="mt-8 inline-flex h-16 px-10 items-center justify-center rounded-xl bg-amber-500 hover:bg-amber-400 transition text-stone-950 text-base font-bold tracking-wide">
