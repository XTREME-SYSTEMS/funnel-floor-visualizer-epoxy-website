  ...
  return (
    <section className="bg-amber-500 py-16 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <Link to="/funnel" className="mt-8 inline-flex h-16 px-10 items-center justify-center rounded-xl bg-stone-950 hover:bg-stone-800 transition text-white text-base font-bold tracking-wide">
