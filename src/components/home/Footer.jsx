      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="inline-block text-xs text-white font-semibold mt-1 px-3 py-1 border-2 border-amber-500 rounded-lg">Powered by America's #1 Largest Epoxy Superstore</div>
