...
const STAGES = ["NEW ESTIMATE", "CONTACT ATTEMPTED", "PHONE CONSULTATION BOOKED", "PHONE CONSULTATION COMPLETED", "IN-HOME ESTIMATE BOOKED", "IN-HOME ESTIMATE COMPLETED", "PROPOSAL SENT", "WON", "LOST", "NURTURE"];
